...
session_start();
    ...
    $sql_str = "SELECT * FROM information WHERE vedio='7' ORDER BY id ASC";
...
<body>
<img src="./images/g.png" alt="" class="titleImg" />
<table class="user" border="1">
    ...
    <?php foreach($row as $item){ ?>
        ...
        <td><?php echo round(intval($item['second'])/88,3)*100; ?>%</td>
        <td><?php if((intval($item['second'])/88) == 1){echo "T";}else{echo "F";} ?></td>
