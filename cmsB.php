...
session_start();
    ...
    $sql_str = "SELECT * FROM information WHERE vedio='2' ORDER BY id ASC";
...
<body>
<img src="./images/b.png" alt="" class="titleImg" />
<table class="user" border="1">
    ...
    <?php foreach($row as $item){
        ...
        <td><?php echo round(intval($item['second'])/41,3)*100; ?>%</td>
        <td><?php if((intval($item['second'])/41) == 1){echo "T";}else{echo "F";} ?></td>
